...
This will run the script with the given "menu.txt" file as the input source. Or you can pass in another text file with "ruby run.rb another_file.txt" This will return an array of each possible combination that amounts to the target price. 
